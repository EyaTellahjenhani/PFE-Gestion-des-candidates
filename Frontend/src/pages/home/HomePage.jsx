...
const HomePage = () => {
  ...
  const [RequestPerPage, setRequestPerPage] = useState(6);
    ...
    <div>
      ...
      <div className="container mx-auto">
        ...
        <p className="text-lg mt-5 mb-5 text-center">
          Vous trouverez ici toutes nos offres disponibles
        </p>
              ...
              <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                {data?.slice(pagesVisited, pagesVisited + RequestPerPage).map((offre) => (
                  <Link key={offre._id} to={"/offre/" + offre._id}>
                    <li className="bg-white min-h-60 hover:bg-gray-100 rounded-lg shadow-md p-6">
